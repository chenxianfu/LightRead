package com.jushiyun.cxf.lightread.adapter;
...
public class BookShelfAdapter extends RefreshRecyclerViewAdapter {
    ...
    public BookShelfAdapter(ArrayList<BookShelfBean> list) {
        super(false);
        this.books = list;
    }
...
//            Glide.with(holder.ivCover.getContext()).load(books.get(index).getBookInfoBean().getCoverUrl()).dontAnimate().diskCacheStrategy(DiskCacheStrategy.RESULT).centerCrop().placeholder(R.drawable.img_cover_default).into(holder.ivCover);
            ...
            holder.tvName.setText(books.get(index).getTitle());
...
//            }
    ...
    class LastestViewHolder extends RecyclerView.ViewHolder {
        ...
        public LastestViewHolder(View itemView) {
            ...
            tvDurprogress = (TextView) itemView.findViewById(R.id.tv_durprogress);
    ...
    class OtherViewHolder extends RecyclerView.ViewHolder {
        ...
        public OtherViewHolder(View itemView) {
            ...
            tvName_1 = (TextView) itemView.findViewById(R.id.tv_name_1);
            ...
            tvName_2 = (TextView) itemView.findViewById(R.id.tv_name_2);
            ...
            tvName_3 = (TextView) itemView.findViewById(R.id.tv_name_3);
